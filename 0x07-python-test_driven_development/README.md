...
Project includes test-driven development using docstring and unittest in Python.
Function Prototypes 
...
tests/6-max_integer_test.py: Python class/script that runs unittests for the function def max_integer(list=[]): (given by alx).
